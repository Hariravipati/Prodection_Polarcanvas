...
@Entity({ name: 'items' })
@Index('item_name_color_type_index', ['itemName', 'itemSize', 'itemColor', 'itemGsm', 'itemBf'], {
  unique: true,
})
export class Items {
  ...
  @Column({ name: 'item_unit', type: 'varchar', length: 10, nullable: true })
  itemUnit?: string;
  ...
  @Column({ name: 'item_status', type: 'varchar', length: 10, default: () => "'Active'" })
  itemStatus: string;

  @Column({ name: 'item_avg_purchase_rate', type: 'double precision', default: () => '0' })
